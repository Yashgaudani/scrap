...
latest_url = "https://api.github.com/repos/dbeaver/dbeaver/releases/latest"
headers = {
...
# Step 2: Use the main releases API to extract that version's assets
all_releases_url = "https://api.github.com/repos/dbeaver/dbeaver/releases"
...
# Save to JSON
output_path = "dbeaver_downloads.json"
